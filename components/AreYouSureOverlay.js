            ...
            <View style={styles.buttonsHolder}>
              <TouchableOpacity style={styles.touchableButton} onPress={this.props.onYes}>
                <ImageBackground source={require('../assets/areyousure/yesButton.png')}
                                 style={[styles.largeButton, styles.yesButton]} resizeMode="stretch"/>
              </TouchableOpacity>
              <TouchableOpacity style={styles.touchableButton} onPress={this.props.onNo}>
                <ImageBackground source={require('../assets/areyousure/noButton.png')}
                                 style={[styles.largeButton, styles.noButton]} resizeMode="stretch"/>
              </TouchableOpacity>
            </View>
          </ImageBackground>
        </View>
