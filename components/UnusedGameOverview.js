...
const InputView = ((props) =>
    <ImageBackground source={require("../assets/Overview/input.png")} resizeMode={"stretch"} style={styles.inputBackground}>
    ...
    render() {
        return (
            <ScrollView style={styles.screen}>
                ...
                <ImageBackground source={require("../assets/Overview/gamesBackground.png")} resizeMode={"stretch"} style={styles.gamesBackground}>
                ...
                <ImageBackground source={require("../assets/Overview/balanceBackground.png")} resizeMode={"stretch"} style={styles.balanceBackground}>
                    <View style={styles.gameTextView}>
                ...
                <ImageBackground source={require("../assets/Overview/HistoryBG.png")} resizeMode={"stretch"} style={styles.HistoryBG}>
                    <View style={styles.gameTextView}>
                        <Text style={[styles.gamesText, this.state.buttonDynamicStyle]}>HISTORY</Text>
                    </View>
                    <View style={styles.balanceInputView}>
                        <ImageBackground source={require("../assets/Overview/historyInput.png")} resizeMode={"stretch"} style={styles.historyInput}>
