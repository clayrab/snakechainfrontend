  ...
  render() {
    return (
      <View style={styles.screen}>
        <ImageBackground source={require("../assets/snakeoil/background.png")} resizeMode={"stretch"} style={styles.mainView}>
          ...
          <Image source={require("../assets/snakeoil/yellowsnake.png")} style={styles.snakeImage} resizeMode={"stretch"} />
          ...
          <View style={styles.ButtonView}>
            <ImageBackground source={require("../assets/snakeoil/yellowButton.png")} resizeMode='stretch' style={styles.succeedButton} >
